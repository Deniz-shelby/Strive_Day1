...
for multiplicate moduls = One Hot Encoding, categorical variables can have many diffrent names so one hot Encoding ensures they have diffrent columns

10. What is the best univariate imputation method to numerical variables? (Explain why)

for multiplicate moduls = Normalization, makes the data a normal distrobution graph. Shows you where most of the data is consitrated instead of sqewed data
